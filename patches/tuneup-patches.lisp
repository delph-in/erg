...
(setf *unlikely-le-types* '(DISCO::DISC_ADV_MLE1 DISCO::LETTER_NAME_LE
			    DISCO::MEALTIME_WORD_LE NUMADJ_NOUN_WORD_LE
			    DISCO::NP_ADV_LE DISCO::SUBCONJ_INF_LE 
			    DISCO::SUBCONJ_INF_3MLE2
			    DISCO::BE_TH_COP_IS_LE DISCO::BE_TH_COP_ARE_LE
			    DISCO::BE_TH_COP_WAS_LE DISCO::BE_TH_COP_WERE_LE
			    DISCO::INT_VP_ADV_POST_WORD_LE 
			    DISCO::FREEREL_PRO_NP_WORD_LE
			    DISCO::MV_SORB_LE DISCO::PDET_ONE_LE 
			    ))

(setf *likely-le-types* '(DISCO::COORD_C_LE DISCO::DISC_ADV_LE 
			  DISCO::QUASIMODAL_LE DISCO::MV_POSS_LE
			  DISCO::HOUR_WORD_LE
			  ))
